...
final class BuildSettings: NSObject {
    ...
    static var serverConfigDefaultHomeserverUrlString: String {
        MDMSettings.serverConfigDefaultHomeserverUrlString ?? "https://p2pchatter.com"
    }
    
    /// Default identity server
    static let serverConfigDefaultIdentityServerUrlString = "https://p2pchatter.com"
        
    static var serverConfigSygnalAPIUrlString: String {
        MDMSettings.serverConfigSygnalAPIUrlString ?? "https://p2pchatter.com/_matrix/push/v1/notify"
    }
